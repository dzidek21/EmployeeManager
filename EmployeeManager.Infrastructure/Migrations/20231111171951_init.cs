    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeProjectHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeProjectHistories_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeProjectHistories_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProjectHistories_EmployeeId",
                table: "EmployeeProjectHistories",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProjectHistories_ProjectId",
                table: "EmployeeProjectHistories",
                column: "ProjectId");
